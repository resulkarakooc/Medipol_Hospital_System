...
namespace Medipol_Hospital
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.KeyDown += new KeyEventHandler(Form1_KeyDown); // Enter tuşu fonksiyonu için 
            ...
            maskedTextBox2.Mask = "000000"; //Validation işlemi zorunlu 6 hane ve sayısal
        ...
        {
            if (maskedTextBox2.Text == a.ToString()) //mail adresine gönderilen kodu doğru girdi mi?
            {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                button1.PerformClick(); //tıkla
                e.Handled = true; // enter tuşunu sadece buna ata 
            }
        }
